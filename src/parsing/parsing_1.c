...
/*   Updated: 2023/12/04 15:37:50 by acosi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_args_parsing(char *cmd, t_struct *itr, t_data *data)
{
	...
	j = 0;
	data->i = data->pos;
	count_quotes_parsing(cmd, data, &j);
...
/*
	...
	list. The first if() ensures that the last node is null-terminated. If a '#' 
...
/*
	...
	Else, if a space or a tab is encoutered, the what follows is
